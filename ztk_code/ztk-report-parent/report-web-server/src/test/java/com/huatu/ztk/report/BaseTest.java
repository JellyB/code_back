...
public abstract class BaseTest extends AbstractJUnit4SpringContextTests {
    ...
    public static void init(){
        System.setProperty("webapp.dir", System.getProperty("user.home")+"/tools/workspace/ztk-report-parent/report-web-server/src/main/webapp");
        System.setProperty("server_name", "report-web-server");
