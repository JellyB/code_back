...
public class RenderCommand extends ConfiguredCommand<AgentConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<AgentConfiguration> bootstrap,
                       Namespace namespace,
                       AgentConfiguration configuration) throws Exception {
