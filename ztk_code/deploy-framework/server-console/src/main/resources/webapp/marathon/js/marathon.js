  ...
  var AppItemView = Backbone.View.extend({
    ...
    template: _.template(
      "<div class='app-item '>" +
        ...
        "</div>" +
        "<div class='action-bar val'>" +
          "<a class='scale val' href='#'>SCALE</a>  | " +
          "<a class='suspend val' href='#'>SUSPEND</a>  | " +
          "<a class='destroy val' href='#'>DESTROY</a>" +
        "</div>" +
      "</div>"
    ),
