...
/**
 * Created by zhuzhangsuo on 16/4/20.
 */
...
public class WebServer {
    ...
    public static void main(String[] args) throws Exception{
        new WebServer("0.0.0.0",8080).start();
    }
    ...
    private void run(String serverAddress, int serverPort,String contentPath) throws Exception {
        ...
        resourceHandler.setResourceBase("/data/projects/dist-source");
        HandlerList handlerList = new HandlerList();
        handlerList.setHandlers(new Handler[]{resourceHandler,webapp});
    ...
    private String getWebappPath() {
        ...
        String home=System.getProperty("server_resources");
        final String serverResources = home+"";//;
        //serverResources 非空
        ...
        System.out.println(serverResources);
        if (webappDir == null) {
            throw new RuntimeException("not found webapp path. please check system property 'user.dir' or 'server_home'");
        }
