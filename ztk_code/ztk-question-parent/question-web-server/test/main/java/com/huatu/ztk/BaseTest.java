...
public abstract class BaseTest extends AbstractJUnit4SpringContextTests {
    ...
    public static void init(){
        System.setProperty("webapp.dir", System.getProperty("user.home")+"/tools/workspace/ztk-user-parent/user-web-server/src/main/webapp");
        System.setProperty("server_name", "question-web-server");
