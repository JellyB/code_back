package com.huatu.ztk.knowledge.common.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.huatu.ztk.knowledge.daoPandora",sqlSessionTemplateRef = "pandoraSqlSessionTemplate")
