 ...
 * Created time 2016-07-19 09:31
 */
public class TestpaperSyncTask implements MessageListener{
    private static final Logger logger = LoggerFactory.getLogger(TestpaperSyncTask.class);
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            //导入新试卷
            initController.importTestPaper2mongo(puKey,null);
        }catch (Exception e){
