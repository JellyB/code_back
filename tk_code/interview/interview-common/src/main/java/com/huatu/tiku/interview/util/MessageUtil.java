...
//        }
    ...
    public static  Map<String, String> getElement(List<Element> elemetList,Map<String,String>map) {

        for (Element sonElement : elemetList) {

            if (sonElement.elements().size() != 0) {
                List<Element> elements = sonElement.elements();
     ...
     * @return xml
     */
    public static String MessageToXml(String content,Map<String, String> requestMap) {
        TextMessage textMessage = new TextMessage(content,requestMap);
        xstream.alias("xml", textMessage.getClass());
        return xstream.toXML(textMessage);
    }
