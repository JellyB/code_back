...
public enum ResultEnum {
    ...
    PHONE_ILLEGAL(50023, "手机号错误，清检查后再发送"),
    WAIT_TO_SEND(50022, "验证码发送过于频繁，请稍后重试"),
...
//    验证通过，提示：验证成功
    ...
    PHP_MOBILE_ERROR(50022, "您的账号未购买该课程"),
    ...
    CLASS_ARRANGEMENT_UNIQUE(50054,"该班级已存在课程安排，不可重复创建"),

    ExcelTypeError(50060,"表格格式不对"),
    ExcelCellError(50061,"表格内容不对"),
    FileEmptyError(50062,"文件为空"),
    ;
