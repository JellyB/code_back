 ...
 */
public class FBXingCeQuestions {
    ...
    private static final String FILE_PREFIX = "D:/fb/questions/xingce";
...
//                    for(String key:keys){
                        QuestionTask xingce = new QuestionTask(offset+500*i, "xingce");
                        xingce.run();
//                    }
                    System.out.print(i+":");
                    Thread.sleep(100);
        ...
        for (Question question : questions) {
            try {
                ...
                if(StringUtils.isNotEmpty(source)){
                    ...
                    int lastIndexOf = source.lastIndexOf("第");
                    source = source.substring(0,lastIndexOf);
                    FileUtils.write(new File(FILE_PREFIX+"/"+source+".txt"), JSON.toJSONString(question)+"\r\n\r\n", Charset.forName("UTF-8"),true);
                }else{
                    FileUtils.write(new File(FILE_PREFIX+"/公务员行测.txt"), JSON.toJSONString(question)+"\r\n\r\n", Charset.forName("UTF-8"),true);
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
