...
import com.arj.monitor.advice.AdviceExcluder;
import com.arj.monitor.aop.session.TokenMethodArgumentResolver;
import com.arj.monitor.exception.CustomErrorHandler;
...
public class SpringBaseConfig {
    ...
    public TokenMethodArgumentResolver tokenMethodArgumentResolver(ConfigurableBeanFactory beanFactory, TokenService tokenService) {
        return new TokenMethodArgumentResolver(beanFactory, tokenService);
    }
