...
public class ZTKResponseUtil {
     ...
     * 默认正确返回值
     */
    public static final SuccessMessage SUCCESS_RESULT = SuccessMessage.create();

    /**
     * 默认异常返回值
     */
    public static final ErrorResult ETTOR_RESULT = ErrorResult.create(DEFAULT_CODE, "服务器异常");
    ...
    public static final Object defaultResult() {
        throw new BizException(ErrorResult.create(DEFAULT_CODE, "服务器异常"));
    }
