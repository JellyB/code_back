...
data_dir=/Users/biguodong/Documents/workspace/huatu/match-web-server
START_TIME=`date +%s`
WORKSPACE=${data_dir}/workspace/
git_url=git@192.168.100.21:tiku/match.git
project_name=match-web-server
git_branch=dev
module=match-web-server
profile=test
...
#mvn clean install -U -Dmaven.test.skip=true -Dmaven.compile.fork=true -pl match-web-server -am -Pdev
